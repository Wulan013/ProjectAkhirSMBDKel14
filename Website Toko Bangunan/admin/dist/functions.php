...
function tambah($data)
{
    ...
    $fotoProduk = htmlspecialchars($data['foto_produk']);
    ...
    $query = "CALL TambahProduk (?, ?, ?, ?)";
    $stmt = mysqli_prepare($conn, $query);
    mysqli_stmt_bind_param($stmt,$IdProduk, $namaProduk, $hargaProduk,$stok, $deskripsiProduk, $fotoProduk);
...
function update($data,$id )
{
    ...
    $fotoProdukLama = htmlspecialchars($data['foto_produk_lama']);
    ...
    $stmt = mysqli_query($conn, "CALL update_barang ('$id', '$nama', '$harga', '$stok', '$deskripsi', '$fotoProduk')");
...
function kirimBukti($data, $idPembeli)
{
    ...
    mysqli_query($conn, "UPDATE pembelian_barang SET status_pembelian = 'lunas'
