...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index.php">Toko Bangunan - Admin</a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button
            ><!-- Navbar Search-->
            ...
            <div id="layoutSidenav_content">
                ...
                <?php
                        if(isset($_GET["halaman"])){
                            ...
                            else if($_GET["halaman"] == "barang-lunas"){
                                include 'barang-lunas.php';
                            }

                            else if($_GET["halaman"] == "masih-diproses"){
                                include 'masih-diproses.php';
                            }
...
$query = "
    ...
    FROM 
        pelanggan
    JOIN 
        pembelian_barang ON pelanggan.id_pelanggan = pembelian_barang.id_pelanggan
    JOIN 
        checkout ON pembelian_barang.id_pembelian = checkout.id_pembelian
";
...
// Tampilkan hasil query dalam tabel HTML
echo "<h2><center>Data Pelanggan dan Checkout</center></h2>";
echo "<table border='1' style='width: 50%; margin: auto; text-align: center;'>";
echo "<tr><th style='padding: 10px;'>Nama Pelanggan</th><th style='padding: 10px;'>Barang Checkout</th></tr>";
while ($row = $result->fetch_assoc()) {
    echo "<tr>";
    echo "<td style='padding: 10px;'>" . $row['Nama_Pelanggan'] . "</td>";
    echo "<td style='padding: 10px;'>" . $row['Nama_Checkout'] . "</td>";
    echo "</tr>";
}
echo "</table>";
