...
<head>
    ...
    <title>Toko Bangunan - Detail Pembelian</title>
...
<body>
    <div class="container-fluid">
        <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="background-color: #979890;">
            <div class="container">
            <a class="navbar-brand" href="#" style="font-size: 23px;">Toko Bangunan</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="odd">
                                                    ...
                                                    <td><?= $barang["nama"]; ?></td>
                                                    <td><?= substr($barang['deskripsi'], 0, 100), ""; ?></td>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group alert alert-info w-auto">
                                        <p class="w-100" style="font-size: medium;">
                                            ...
                                            <!-- <br> -->
                                            <strong>BANK BRI 4199-0101-0791-531 AN. TB Jaya Lestari</strong>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12">
